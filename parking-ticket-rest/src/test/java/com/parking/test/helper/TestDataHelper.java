...
/**
 * Test class to generate mock data for unit testing for REST layer.
...
public class TestDataHelper {
	...
	/**
	 * Returns mock data for parking lot.
	 * @return parking lot instance
	 */
	public static ParkingLot getMockParkingLot() {
		ParkingLot lot = new ParkingLot();
		lot.setAddress("1111 W Taylor st.");
		lot.setEmail("abc@gmail.com");
		lot.setPhoneNumber(1234567890);
		lot.setCostPerHr(2.5);
		return lot;
	}
